    ...
    <motion.div
     ...
     overflow-hidden' id='Contact'>
      <h1 className='text-3xl sm:text-4xl md:text-5xl font-bold mb-3 text-gray-800'>
        Contact <span className='underline underline-offset-8 decoration-2 decoration-gray-300 font-light'>With Us</span>
      </h1>
      <p className='text-gray-500 max-w-lg mx-auto text-lg mb-15'>
