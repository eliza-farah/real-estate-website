      ...
      <div className='container mx-auto flex flex-col md:flex-row
       justify-between items-center'>
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
          ...
          <p className='text-gray-400 mt-4'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatem vel quibusdam blanditiis porro ipsam nisi nobis tempore reiciendis rem? Mollitia.</p>
        </div>
        ...
        <div className='w-full md:w-1/3'>
          ...
          <p className='text-gray-400 mb-4 mx-w-80'>The latest news, articles, and resources, sent
